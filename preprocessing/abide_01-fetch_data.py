...
def main_multiview():
    ...
    for i, subject_ID in enumerate(subject_IDs):
        Reader.subject_multiview_connectivity(time_series[i], subject_ID, atlas, 'correlation', n_view=3,
                                              save_path=data_folder)
        Reader.subject_multiview_connectivity(time_series[i], subject_ID, atlas, 'partial correlation',
                                              n_view=3,
                                              save_path=data_folder)
